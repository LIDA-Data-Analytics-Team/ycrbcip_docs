...
1. If you're accessing LASER Biscom for the first time:
    ...
    <img width="800" src="img/biscom_import_notification_example_1.png" alt="Biscom notification email"><br>
    1. Click the link in this email and you'll be taken to Biscom's registration page:<br>
    <img width="600" src="img/biscom_import_registration_example.png" alt="Biscom registration page"><br>
    ...
    <img width="600" src="img/biscom_import_login_example_1.png" alt="Biscom login screen"><br>
...
<img width="800" src="img/biscom_import_inbox_example.png" alt="Biscom inbox page"><br>
...
<img width="800" src="img/biscom_import_send_example.png" alt="Send files to LASER via Biscom"><br>
...
<img width="800" src="img/biscom_import_file_download_example.png" alt="Download files from LASER Biscom"><br>
